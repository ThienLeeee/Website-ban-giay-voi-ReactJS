      ...
      <section id="ega-breadcrumb" className="ega-p-t--3 ega-p-b--3">
        <div className="ega-container">
          <ul className="ega-menu ega-ul ega-menu--breadcrumb ega-m--0">
            ...
            <li className="ega-menu__item">
              <a href="?mod=pages&act=shop">Sản phẩm khuyến mãi</a>
            </li>
          </ul>
        </div>
        {/* section */}
        ...
        <div className="ega-col-xl-12 ega-col-lg-12 ega-col-12">
          <div id="result">
            <div className="ega-row">
              <div className="ega-col-lg-4 ega-col-sm-4 ega-col-6">
                  ...
                  >
                    ...
                    <div className="ega-pro__content">
                      ...
                      <div className="ega-pro__price-group">
                        ...
                        <del className="ega-pro__price-del ega-small ega-color--secondary">
                          000.000₫
                        </del>
                      </div>
                    </div>
                    <div className="ega-pro__sale-tag style2">
                      <span>-17%</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="ega-col-lg-4 ega-col-sm-4 ega-col-6">
                <div className="pd-item__wrapper">
                  ...
                  >
                    <div className="ega-pro__img">
                      <a
                        href="?mod=pages&act=chitietsp&id=2"
                        className="ega-text--no-underline"
                      >
                        <img
                          src="./img/giayAdidas2.png
"
                        />
                      </a>
                    </div>
                    <div className="ega-pro__content">
                      <h3 className="ega-pro__title ega-m-t--0 ega-h5">
                        <a href="" className="ega-text--no-underline">
                          Giày adidas VL Court Base Nam - Trắng Xanh
                        </a>
                      </h3>
                      <div className="ega-pro__price-group">
                        <ins className="ega-pro__price ega-text--no-underline ega-color--danger">
              ...
              <div className="ega-col-lg-4 ega-col-sm-4 ega-col-6">
                <div className="pd-item__wrapper">
                  ...
                  >
                    <div className="ega-pro__img">
                      <a
                        href="?mod=pages&act=chitietsp&id=5"
                        className="ega-text--no-underline"
                      >
                        <img
                          src="./img/giayAdidas5.png
"
                        />
                      </a>
                    </div>
                    <div className="ega-pro__content">
                      <h3 className="ega-pro__title ega-m-t--0 ega-h5">
                        <a href="" className="ega-text--no-underline">
                          Giày adidas Advancourt Base Nam - Trắng Camo
                        </a>
                      </h3>
                      <div className="ega-pro__price-group">
                        <ins className="ega-pro__price ega-text--no-underline ega-color--danger">
              ...
              <div className="ega-col-lg-4 ega-col-sm-4 ega-col-6">
                <div className="pd-item__wrapper">
                  ...
                  >
                    <div className="ega-pro__img">
                      <a
                        href="?mod=pages&act=chitietsp&id=8"
                        className="ega-text--no-underline"
                      >
                        <img
                          src="./img/giayAdidas8.png
"
                        />
                      </a>
                    </div>
                    <div className="ega-pro__content">
                      <h3 className="ega-pro__title ega-m-t--0 ega-h5">
                        <a href="" className="ega-text--no-underline">
                          Giày adidas Ultraboost Light Nam - Xám Đen Xanh
                        </a>
                      </h3>
                      <div className="ega-pro__price-group">
                        <ins className="ega-pro__price ega-text--no-underline ega-color--danger">
              ...
              <div className="ega-col-lg-4 ega-col-sm-4 ega-col-6">
                <div className="pd-item__wrapper">
                  ...
                  >
                    <div className="ega-pro__img">
                      <a
                        href="?mod=pages&act=chitietsp&id=12"
                        className="ega-text--no-underline"
                      >
                        <img src="./img/giayNike4.png" />
                      </a>
                    </div>
                    <div className="ega-pro__content">
                      <h3 className="ega-pro__title ega-m-t--0 ega-h5">
                        <a href="" className="ega-text--no-underline">
                          Giày Nike Interact Run SE Nam - Đen Đen
                        </a>
                      </h3>
                      <div className="ega-pro__price-group">
                        <ins className="ega-pro__price ega-text--no-underline ega-color--danger">
              ...
              <div className="ega-col-lg-4 ega-col-sm-4 ega-col-6">
                <div className="pd-item__wrapper">
                  ...
                  >
                    <div className="ega-pro__img">
                      <a
                        href="?mod=pages&act=chitietsp&id=14"
                        className="ega-text--no-underline"
                      >
                        <img src="./img/giayNike6.png" />
                      </a>
                    </div>
                    <div className="ega-pro__content">
                      <h3 className="ega-pro__title ega-m-t--0 ega-h5">
                        <a href="" className="ega-text--no-underline">
                          Giày Nike Interact Run Nữ - Hồng Nhẹ
                        </a>
                      </h3>
                      <div className="ega-pro__price-group">
                        <ins className="ega-pro__price ega-text--no-underline ega-color--danger">
